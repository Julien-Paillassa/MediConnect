...
export class InitDatabase1697192801264 implements MigrationInterface {
  ...
  public async up (queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('CREATE TABLE "user" ("id" SERIAL NOT NULL, "name" character varying(100) NOT NULL, "password" character varying(100) NOT NULL, "subscriptionId" integer, CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))')
    await queryRunner.query('CREATE TABLE "subscription" ("id" SERIAL NOT NULL, "price" integer NOT NULL, "duration" integer NOT NULL, CONSTRAINT "PK_8c3e00ebd02103caa1174cd5d9d" PRIMARY KEY ("id"))')
