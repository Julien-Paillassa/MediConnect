...
INSERT INTO "subscription" ("id", "userId", "planId", "active") VALUES (1, 'cus_P0sY70OlHhDA8s', 'price_1OCpuRIoREqLVWCHrmMNY0Lf', true);
INSERT INTO "subscription" ("id", "userId", "planId", "active") VALUES (2, 'cus_P0sYvmHEkeQD1e', 'price_1OCpwpIoREqLVWCHxeAiU2mj', true);
INSERT INTO "subscription" ("id", "userId", "planId", "active") VALUES (3, 'cus_P0sZIkprjrwuDs', 'price_1OCpyHIoREqLVWCHp7PCq1vN', true);

UPDATE "user" SET "subscriptionId" = 1 WHERE "id" = 'cus_P0sY70OlHhDA8s';
UPDATE "user" SET "subscriptionId" = 2 WHERE "id" = 'cus_P0sYvmHEkeQD1e';
UPDATE "user" SET "subscriptionId" = 3 WHERE "id" = 'cus_P0sZIkprjrwuDs';
